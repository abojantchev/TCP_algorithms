...
while :
do
	echo "15000kbps for 5 seconds"
	sudo tc qdisc change dev lo root tbf rate 15000kbit buffer 10000000 limit 500000000 peakrate 15001kbit minburst 1550
	sleep 5
	echo "50000kbps for 10 seconds"
	sudo tc qdisc change dev lo root tbf rate 50000kbit buffer 10000000 limit 500000000 peakrate 50001kbit minburst 1550
	sleep 10
	echo "30000kbps for 7 seconds"
	sudo tc qdisc change dev lo root tbf rate 30000bit buffer 10000000 limit 500000000 peakrate 30001kbit minburst 1550
	sleep 7
done
