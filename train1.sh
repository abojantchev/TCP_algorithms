...
while :
do
	echo "3000kbps for 5 seconds"
	sudo tc qdisc change dev lo root tbf rate 3000kbit buffer 10000000 limit 500000000 peakrate 3001kbit minburst 1550
	sleep 5
	echo "5000kbps for 10 seconds"
	sudo tc qdisc change dev lo root tbf rate 5000kbit buffer 10000000 limit 500000000 peakrate 5001kbit minburst 1550
	sleep 10
	echo "4000kbps for 5 seconds"
	sudo tc qdisc change dev lo root tbf rate 4000bit buffer 10000000 limit 500000000 peakrate 4001kbit minburst 1550
	sleep 5
done
